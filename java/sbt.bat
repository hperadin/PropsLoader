...
set JVM_PARAMS=-Xss2m -Xms3g -Xmx3g -XX:+TieredCompilation -XX:ReservedCodeCacheSize=512m -XX:MaxPermSize=768m -XX:+CMSClassUnloadingEnabled -XX:+UseNUMA -XX:+UseParallelGC -Dscalac.patmat.analysisBudget=off
...
:RUN_LOOP
copy ..\Common\BuildSettings\* project > NUL
%RUN_CMD%
